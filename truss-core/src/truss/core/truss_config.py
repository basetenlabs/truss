...
import yaml
from truss.core.constants import HTTP_PUBLIC_BLOB_BACKEND
from truss.core.errors import ValidationError
from truss.core.types import ModelFrameworkType
from truss.core.util.data_structures import transform_optional
from truss.core.validation import (
    validate_cpu_spec,
