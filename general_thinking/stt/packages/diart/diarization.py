...
# from whisper_chain_utils.whisper_chain_data_types import DiarizationResult
import logging
...
class SpeakerDiarization(base.Pipeline):
    ...
    def __call__(
        self, waveforms: Sequence[SlidingWindowFeature], diarization_result
        ...
        segmentations = torch.from_numpy(diarization_result.segmentation.array)
        embeddings = torch.from_numpy(diarization_result.embedding.array)
