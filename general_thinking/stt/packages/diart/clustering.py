...
class OnlineSpeakerClustering:
    ...
    def init_centers(self, dimension: int):
        ...
        """
        logger.debug(f"Initializing centers: {self.max_speakers} x {dimension}")
    ...
    def identify(self, segmentation: SlidingWindowFeature, embeddings: torch.Tensor) -> SpeakerMap:
        ...
        for spk in missed_speakers:
            ...
            if has_space and spk in long_speakers:
                ...
                preferences = [g_spk for g_spk in preferences if g_spk in self.active_centers]
