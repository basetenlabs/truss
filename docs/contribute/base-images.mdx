...
4. Once the PR is ready to land, use the [image generation script](https://github.com/basetenlabs/truss/blob/main/bin/generate_base_images.py) to build and publish base images. Make sure to use the value of `TRUSS_BASE_IMAGE_VERSION_TAG` for version tag.
5. Merge the PR.
