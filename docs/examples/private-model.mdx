...
self._model = pipeline(
    "fill-mask",
    model="philipkiely-baseten/private-model",
...
1. Go to the [model page on Hugging Face](https://huggingface.co/philipkiely-baseten/private-model) and accept the terms to access the model.
...
```sh
truss predict '"The meaning of life is [MASK]"'
```
