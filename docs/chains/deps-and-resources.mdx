...
if __name__ == "__main__":
    """
    To test this out locally, we can define a mock MistralLLM
    Chainlet that has the same protocol as the MistralLLM Chainlet.

    This way, we can run this chainlet locally without needing a GPU.
    """
