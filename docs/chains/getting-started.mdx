...
```bash
$ pip install truss==0.9.10rc2 --upgrade
```
...
1. Add file requirements file to the directory `echo "git+https://github.com/basetenlabs/truss.git" > requirements.txt`
, you can a more requirements later.
...
class HelloWorld(chains.ChainletBase):
    remote_config = chains.RemoteConfig(
        docker_image=chains.DockerImage().pip_requirements_file(
