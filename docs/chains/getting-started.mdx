...
Truss Chains is available in a rc version of Truss.
...
class HelloWorld(chains.ChainletBase):
    ...
    def run_remote(self, num_repetitions: int) -> str:
...
if __name__ == "__main__":
    with chains.run_local():
        ...
        result = my_hello_world.run_remote(num_repetitions=3)
...
For more options run `truss chains deploy --help`.
