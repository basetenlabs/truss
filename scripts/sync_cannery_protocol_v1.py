...
CONTRACT_FILES = (
    ...
    "v1.md",
    "fixtures/protobuf-delimited/.gitattributes",
    "fixtures/protobuf-delimited/list-quota-error.bin",
    "fixtures/protobuf-delimited/list-success.bin",
    "fixtures/protobuf-delimited/pull-cancelled.bin",
    "fixtures/protobuf-delimited/pull-integrity-error.bin",
    "fixtures/protobuf-delimited/pull-invalid-include.bin",
    "fixtures/protobuf-delimited/pull-no-match.bin",
    "fixtures/protobuf-delimited/pull-success.bin",
    "fixtures/protobuf-delimited/push-success.bin",
    "fixtures/protobuf-delimited/push-throttled.bin",
    "fixtures/protobuf-delimited/show-not-found.bin",
    "fixtures/protobuf-delimited/show-success.bin",
