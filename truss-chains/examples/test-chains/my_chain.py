...
class HelloWorld(chains.ChainletBase):
    remote_config = chains.RemoteConfig(
        docker_image=chains.DockerImage(
            pip_requirements=["git+https://github.com/basetenlabs/truss.git@e84bd0c753d7cbc231130ea73d20778f9a7422ae", "opentelemetry-api","opentelemetry-sdk","opentelemetry-exporter-otlp"]
        ),
    )
