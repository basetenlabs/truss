...
class SyncClient:
    ...
    Example:
        >>> client = SyncClient(api_base="https://example.api.baseten.co/environments/production/sync", api_key="your_api_key")
    ...
    def __init__(
        ...
        Example:
            >>> client = SyncClient(api_base="https://example.api.baseten.co/sync", api_key="your_key")
        """
        ...
