...
import yaml
from truss_common.constants import HTTP_PUBLIC_BLOB_BACKEND
from truss_common.errors import ValidationError
from truss_common.types import ModelFrameworkType
from truss_common.util.data_structures import transform_optional
from truss_common.validation import (
    validate_cpu_spec,
