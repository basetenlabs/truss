...
from truss.server.common.util import assign_request_to_inputs_instances_after_validation
from truss.server.secrets_resolver import SecretsResolver
...
class ModelWrapper(kserve.Model):
    ...
    def postprocess(
        self, response: Union[Dict], headers: Dict[str, str] = None
    ) -> Dict:
    ...
    def predict(
        self, payload: Union[Dict], headers: Dict[str, str] = None
    ) -> Union[Dict]:
        try:
